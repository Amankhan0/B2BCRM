      ...
      <div className='grid grid-cols-2 gap-10'>
        <div className='bg-white'>
          ...
          <div className='grid grid-cols-2 gap-6 p-3 bg-white rounded-b-xl'>
            <DatePicker dateOption={{ enableTime: true, time_24hr: false }} name='genratedDate' title={ApiReducer.tripForm === 'withoutEway' ? 'Created On' : 'Trip start date & time (ETD)'} placeholder={ApiReducer.tripForm === 'withoutEway' ? 'Enter created date' : 'Trip start date & time (ETD)'} important={true} currentTime={true} />
            ...
            <MyInput disable={editPage === 'edit'} createTripJson name={'vehicleNumber'} title={'Vehicle Number'} placeholder={'Vehicle Number'} />
